  ...
  return (
    <div className="rounded-lg border border-neutral-200 dark:border-neutral-100 bg-white dark:bg-card p-5 shadow-card">
      <div className="flex items-center justify-between mb-3">
        <h2 className="font-semibold text-neutral-800 dark:text-neutral-700">Busdev/AE Assigned</h2>
        {!editing ? (
          <Button
            size="icon"
            variant="ghost"
      ...
      {editing ? (
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-medium text-neutral-800 dark:text-neutral-700">{ae.name}</span>
        </div>
      ) : (
